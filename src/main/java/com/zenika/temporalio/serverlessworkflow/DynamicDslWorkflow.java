...
import com.zenika.temporalio.serverlessworkflow.model.WorkflowData;
import com.zenika.temporalio.serverlessworkflow.utils.DslWorkflowUtils;
import com.zenika.temporalio.serverlessworkflow.utils.JQFilter;
    ...
    Workflow.registerListener(
        (DynamicSignalHandler)
            (signalName, encodedArgs) -> {
              ...
              // Add input as results and so on for the next steps
              workflowData.addResults((ObjectNode) encodedArgs.get(0, JsonNode.class));
