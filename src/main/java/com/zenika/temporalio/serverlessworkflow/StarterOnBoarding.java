...
import static com.zenika.temporalio.serverlessworkflow.utils.DslWorkflowUtils.*;
...
public class StarterOnBoarding {
  ...
  public static void main(String[] args) {
    ...
    runZenikaOnboardingWorkflow();

    System.exit(0);
  }

  private static void runZenikaOnboardingWorkflow() {
    runWorkflow("onboarding", "1.0", "zenikaapplicantdatainput.json", false);
  }
